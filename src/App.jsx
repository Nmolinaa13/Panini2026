...
// Nomenclatura: FWC00..FWC19, COL01..COL20, CC01..CC14
// Posición 1: escudo, 2-12: jugadores 1-11, 13: foto equipo, 14-20: jugadores 12-18
function buildStickers() {
  const all = [];
  // FWC especiales: FWC00 a FWC19
  for (let i = 0; i <= 19; i++) {
    ...
    <div style={{ position: "relative", display: "inline-flex" }}>
      ...
      >
        <span style={{ fontSize: 8, opacity: 0.7, lineHeight: 1 }}>
          {sticker.id.replace(sticker.team, "")}
        </span>
