          ...
          {tab === "album" && (
            <div>
              ...
              <p style={{ fontSize: 11, color: "#475569", marginBottom: 14 }}>
                Toca el número para <strong style={{ color: "#4ade80" }}>agregar</strong> · toca <strong style={{ color: "#4ade80" }}>−</strong> para quitar
              </p>
                    ...
                    <div key={team} style={{ marginBottom: 10, background: "#0f172a", borderRadius: 12, overflow: "hidden", border: "1px solid #1e293b" }}>
                      <div style={{ padding: "8px 12px", background: `${grpColor}18`, borderLeft: `3px solid ${grpColor}`, borderBottom: "1px solid #1e293b" }}>
                        <span style={{ fontFamily: "'Bebas Neue'", fontSize: 14, letterSpacing: 2 }}>
                          {flag} {TEAM_NAMES[team] || team} <span style={{ color: grpColor, fontSize: 11 }}>({stickers.length} faltan)</span>
                        </span>
                      </div>
                        ...
                        {stickers.map(s => (
                          <button key={s.id} onClick={() => { addSticker(s.id); notify(`✅ ${s.id} conseguida`, "ok"); }}
                            style={{
                              ...
                              color: "#94a3b8", padding: "6px 10px", fontSize: 12, cursor: "pointer", fontWeight: 700,
                            }}
